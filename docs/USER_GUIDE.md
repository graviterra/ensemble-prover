...
Provider cooldown identities use keyed fingerprints. The first credential-bearing
provider client creates `provider-identity.key` and `provider-identity.lock` in
