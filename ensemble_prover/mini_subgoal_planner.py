    ...
    *,
    ...
    parts = [
        ...
        (
            ...
            "A `root_assembly` schema for the supplied target may use that "
            "empty check: Lean contract validation, not sanity prose, establishes "
            "its correspondence to the root. New mathematical dependencies "
